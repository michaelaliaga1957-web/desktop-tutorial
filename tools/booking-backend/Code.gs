...
'<div style="font-family:Arial,Helvetica,sans-serif;max-width:560px;margin:0 auto;border:1px solid #e5e0d5;">' +
  ...
  '<div style="padding:28px;">' +
    ...
    '<p style="color:#444;line-height:1.6;">Remember: we bring everything — our own water &amp; power. Just have your vehicle accessible and we\'ll take care of the rest.</p>' +
  '</div>' +
